library gstG2Dvideorotate;

{------------------------------------------------------------------------------
  gstG2Dvideorotate

  Standalone GStreamer plugin DLL example for a Delphi/OpenCV rotate element.
  ...
  Dynamic loader export:
    gst_plugin_g2dvideorotate_get_desc
    gst_plugin_G2Dvideorotate_get_desc
------------------------------------------------------------------------------}
...
uses
  ...
  G2D.Plugin.VideoRotate in 'G2D.Plugin.VideoRotate.pas';

const
  G2D_PLUGIN_NAME             = 'g2dvideorotate';
  G2D_PLUGIN_DESCRIPTION      = 'G2D Delphi video rotate filter plugin';
...
begin
  try
    ...
    Result := G2DRegisterVideoRotate(plugin);
  except
    Result := 0;
  end;
end;
...
function gst_plugin_g2dvideorotate_get_desc: PGstPluginDesc; cdecl;
begin
  InitPluginDesc;
  Result := @GPluginDesc;
end;

procedure gst_plugin_g2dvideorotate_register; cdecl;
begin
  InitPluginDesc;
  try
    G2D_RequirePluginAPI;
...
exports
  gst_plugin_g2dvideorotate_get_desc,
  gst_plugin_g2dvideorotate_get_desc name 'gst_plugin_G2Dvideorotate_get_desc',
  gst_plugin_g2dvideorotate_register,
  gst_plugin_g2dvideorotate_register name 'gst_plugin_G2Dvideorotate_register';
