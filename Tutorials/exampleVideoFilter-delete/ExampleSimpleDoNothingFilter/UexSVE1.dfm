object Form1: TForm1
  Left = 0
  Top = 0
  Caption = 'Example Simple Video Filter element'
  ClientHeight = 451
  ClientWidth = 835
  Color = clBtnFace
    ...
    object Panel2: TPanel
      ...
      object RichEdit1: TRichEdit
        ...
        Lines.Strings = (
          ...
          '1. a simple element (Filter)'
          '2. a full element with a plugin'
          
          'Here we build a primative simple filter element that doos nothing'
          'The pipeline chain:'
          'autovideosrc->Filter(does nothing)->videoconvert->videosink')
        ParentFont = False
        ReadOnly = True
        ScrollBars = ssBoth
        TabOrder = 0
